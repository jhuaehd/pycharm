...
# Main code
print('Welcome to Higher or Lower Game Card.')
print('You hava to choose whether the next card to be shown will be higher or lower than the current card.')
...
while True:  # play multiple games
    ...
    for cardnumber in range(0, NCARDS):
        answer = input('Will the next card will be higher or lower'
                       ' than the ' + currentCardRank + ' of ' + currentCardSuit + '? (enter h or l):')
        ...
        if answer == 'h':
            if nextCardValue > currentCardValue:
                print('You got it rightm, it was higher')
                score += 20
            else:
